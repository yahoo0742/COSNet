...
def get_10x_lr_params(model):
    ...
    if torch.cuda.device_count() == 1:
        ...
        b.append(model.module.depth_encoder.backbone.conv1)
        b.append(model.module.depth_encoder.backbone.bn1)
        b.append(model.module.depth_encoder.backbone.layer1)
        b.append(model.module.depth_encoder.backbone.layer2)
        b.append(model.module.depth_encoder.backbone.layer3)
        b.append(model.module.depth_encoder.backbone.layer4)
        b.append(model.module.depth_encoder.aspp)
        b.append(model.module.depth_encoder.main_classifier)
...
def main():
    ...
    if args.dataset == 'hzfurgbd':
        db_train = rgbddb.HzFuRGBDVideos(user_config["train"]["dataset"]["hzfurgbd"]["data_path"], inputRes=input_size, transform=None)
